...
// I did not even wrote the code myself, I'll just let the lecture here for completeness, I'm really used to use if statements in Python and Js.
// Not only that, but I already did exercises using if statements.
